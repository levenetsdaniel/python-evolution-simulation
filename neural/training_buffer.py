...
class TrainingBuffer:
    """Collect and post-process ML training samples emitted by the simulation."""
    ...
    def record_birth(
        ...
        env_vec = [temp_norm, food_norm, env_params["hazard_level"]]
    ...
    def to_numpy(self) -> tuple[np.ndarray, np.ndarray, np.ndarray]:
        ...
        x = np.array([
            ...
            + [s.population_mean_fitness, s.parent_mean_fitness]
            for s in completed
        ], dtype=float)
